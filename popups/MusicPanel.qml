...
// Standalone Now Playing popover (macOS: the menu-bar media item opens its own
// player, separate from the Now Playing module inside Control Centre). Shows
// album art, title/artist, a live scrubber, transport and a volume slider.
Variants {
